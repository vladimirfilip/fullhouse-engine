...
def _decide_postflop(state):
    ...
    if street == "river":
        ...
        # PATCH (river_tighter): was 0.30 — fold to smaller river bets too,
        # if D1 shows we're paying off too thinly on rivers.
        if made <= 1 and harmonic_frac > 0.22 and villain["raise_rate"] < 0.45:
            return {"action": "fold"}
